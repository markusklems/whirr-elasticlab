...
public class JavaMain {
  ...
  JavaMain(Command... commands) throws IOException {
    this(newArrayList(commands));
  }
  
  JavaMain(Iterable<Command> commands) throws IOException {
  ...
  public static int main(String... args) throws Exception {
    ...
    JavaMain main = new JavaMain(loader);

   return main.run(System.in, System.out, System.err, Arrays.asList(args));
    //System.exit(rc);
  }
}
